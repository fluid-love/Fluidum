...
#ifdef Fluidum_Path
	constexpr inline const char* ImGuiDefaultFontFilePath = Fluidum_Path "Resources/Fonts/clamp-1m-20200415/clamp-1m-w3-bold.ttf";
...
#else
	constexpr inline const char* ImGuiDefaultFontFilePath = FU::File::MakePath<FU::File::PathArg(__FILE__), 5, FU::File::PathArg("/Resources/Fonts/clamp-1m-20200415/clamp-1m-w1-bold.ttf")>();
