...
FS::Lua::Ret FS::Lua::Calc::array_pop_back(State L) {
...
template
FS::Lua::Ret FS::Lua::Calc::array_pop_back<FD::Calc::Array::ValueType::Number>(State L);
template
FS::Lua::Ret FS::Lua::Calc::array_pop_back<FD::Calc::Array::ValueType::String>(State L);
template
FS::Lua::Ret FS::Lua::Calc::array_pop_back<FD::Calc::Array::ValueType::Bit>(State L);
