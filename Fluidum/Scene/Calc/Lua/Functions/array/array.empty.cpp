...
FS::Lua::Ret FS::Lua::Calc::array_empty(State L) {
...
template
FS::Lua::Ret FS::Lua::Calc::array_empty<FD::Calc::Array::ValueType::Number>(State L);
template
FS::Lua::Ret FS::Lua::Calc::array_empty<FD::Calc::Array::ValueType::String>(State L);
template
FS::Lua::Ret FS::Lua::Calc::array_empty<FD::Calc::Array::ValueType::Bit>(State L);
