...
namespace FD::Project::Internal::Name {
	...
	constexpr inline const char* ProjectFolder = ".fluidum/Project/";
	...
	constexpr inline const char* BackupFolder = ".fluidum/Backup/";

	constexpr inline const char* SrcFolder = "Src/";
